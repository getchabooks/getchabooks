...
/**
 * Base class that represents a row from the 'dept' table.
 *
 * 
 *
 * @package    propel.generator..om
 */
abstract class BaseDept extends Spiderable  implements Persistent
{
	 ...
	 * @return     Dept The current object (for fluent API support)
	 */
	public function setAbbr($v)
	{
		...
		if ($this->abbr !== $v) {
			$this->abbr = $v;
			$this->modifiedColumns[] = DeptPeer::ABBR;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = DeptPeer::NAME;
		}
	...
	public function setTermId($v)
	{
		...
		if ($this->term_id !== $v) {
			$this->term_id = $v;
			$this->modifiedColumns[] = DeptPeer::TERM_ID;
		}
	...
	public function setSpideredAt($v)
	{
		...
		if ($this->spidered_at !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = DeptPeer::SPIDERED_AT;
			}
	...
	public function setShallowSpideredAt($v)
	{
		...
		if ($this->shallow_spidered_at !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = DeptPeer::SHALLOW_SPIDERED_AT;
			}
		} // if either are not null
	...
	public function setTouched($v)
	{
		...
		if ($this->touched !== $v) {
			$this->touched = $v;
			$this->modifiedColumns[] = DeptPeer::TOUCHED;
		}
	...
	public function setBId($v)
	{
		...
		if ($this->b_id !== $v) {
			$this->b_id = $v;
			$this->modifiedColumns[] = DeptPeer::B_ID;
		}
	...
	public function setBookstoreType($v)
	{
		...
		if ($this->bookstore_type !== $v) {
			...
			$this->modifiedColumns[] = DeptPeer::BOOKSTORE_TYPE;
		}
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = DeptPeer::ID;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ($this->created_at !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = DeptPeer::CREATED_AT;
			}
		} // if either are not null
	...
	public function setUpdatedAt($v)
	{
		...
		if ($this->updated_at !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = DeptPeer::UPDATED_AT;
			}
		} // if either are not null
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->abbr = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
			$this->name = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->term_id = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			...
			return $startcol + 11; // 11 = DeptPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating Dept object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = DeptPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($isInsert) {
				...
				// spiderable behavior
				if (!$this->isColumnModified(DeptPeer::SPIDERED_AT)) {
				            $this->setSpideredAt(NULL);
				    }
				// timestampable behavior
				if (!$this->isColumnModified(DeptPeer::CREATED_AT)) {
					$this->setCreatedAt(time());
				}
				if (!$this->isColumnModified(DeptPeer::UPDATED_AT)) {
					$this->setUpdatedAt(time());
				}
			} else {
				$ret = $ret && $this->preUpdate($con);
				// timestampable behavior
				if ($this->isModified() && !$this->isColumnModified(DeptPeer::UPDATED_AT)) {
					$this->setUpdatedAt(time());
				}
			}
			if ($ret) {
				...
				$this->postSave($con);
				DeptPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(DeptPeer::ABBR)) {
			$modifiedColumns[':p' . $index++]  = '`ABBR`';
		}
		if ($this->isColumnModified(DeptPeer::NAME)) {
			$modifiedColumns[':p' . $index++]  = '`NAME`';
		}
		if ($this->isColumnModified(DeptPeer::TERM_ID)) {
			$modifiedColumns[':p' . $index++]  = '`TERM_ID`';
		}
		if ($this->isColumnModified(DeptPeer::SPIDERED_AT)) {
			$modifiedColumns[':p' . $index++]  = '`SPIDERED_AT`';
		}
		if ($this->isColumnModified(DeptPeer::SHALLOW_SPIDERED_AT)) {
			$modifiedColumns[':p' . $index++]  = '`SHALLOW_SPIDERED_AT`';
		}
		if ($this->isColumnModified(DeptPeer::TOUCHED)) {
			$modifiedColumns[':p' . $index++]  = '`TOUCHED`';
		}
		if ($this->isColumnModified(DeptPeer::B_ID)) {
			$modifiedColumns[':p' . $index++]  = '`B_ID`';
		}
		if ($this->isColumnModified(DeptPeer::BOOKSTORE_TYPE)) {
			$modifiedColumns[':p' . $index++]  = '`BOOKSTORE_TYPE`';
		}
		if ($this->isColumnModified(DeptPeer::ID)) {
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = DeptPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = DeptPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['Dept'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['Dept'][$this->getPrimaryKey()] = true;
		$keys = DeptPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getAbbr(),
			$keys[1] => $this->getName(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[0], $arr)) $this->setAbbr($arr[$keys[0]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(DeptPeer::ABBR)) $criteria->add(DeptPeer::ABBR, $this->abbr);
		if ($this->isColumnModified(DeptPeer::NAME)) $criteria->add(DeptPeer::NAME, $this->name);
		if ($this->isColumnModified(DeptPeer::TERM_ID)) $criteria->add(DeptPeer::TERM_ID, $this->term_id);
		if ($this->isColumnModified(DeptPeer::SPIDERED_AT)) $criteria->add(DeptPeer::SPIDERED_AT, $this->spidered_at);
		if ($this->isColumnModified(DeptPeer::SHALLOW_SPIDERED_AT)) $criteria->add(DeptPeer::SHALLOW_SPIDERED_AT, $this->shallow_spidered_at);
		if ($this->isColumnModified(DeptPeer::TOUCHED)) $criteria->add(DeptPeer::TOUCHED, $this->touched);
		if ($this->isColumnModified(DeptPeer::B_ID)) $criteria->add(DeptPeer::B_ID, $this->b_id);
		if ($this->isColumnModified(DeptPeer::BOOKSTORE_TYPE)) $criteria->add(DeptPeer::BOOKSTORE_TYPE, $this->bookstore_type);
		if ($this->isColumnModified(DeptPeer::ID)) $criteria->add(DeptPeer::ID, $this->id);
		if ($this->isColumnModified(DeptPeer::CREATED_AT)) $criteria->add(DeptPeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(DeptPeer::UPDATED_AT)) $criteria->add(DeptPeer::UPDATED_AT, $this->updated_at);
	...
	{
		$criteria = new Criteria(DeptPeer::DATABASE_NAME);
		$criteria->add(DeptPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Dept (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Dept Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 * If this Dept is new, it will return
	 * an empty collection or the current collection; the criteria is ignored on a new object.
	 *
	 * @param      Criteria $criteria optional Criteria object to narrow the query
	 * @param      PropelPDO $con optional connection object
	 * @return     PropelCollection|array Course[] List of Course objects
	 * @throws     PropelException
	 */
	...
	{
		return (string) $this->exportTo(DeptPeer::DEFAULT_STRING_FORMAT);
	}
